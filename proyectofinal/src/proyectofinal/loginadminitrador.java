 ...
 * @author Dmorillo
 */
public class loginadminitrador extends javax.swing.JFrame {
    
    /**
     * Creates new form loginadminitrador
     */
    public loginadminitrador() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loginadminitrador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new loginadminitrador().setVisible(true);
            }
        });
    }
