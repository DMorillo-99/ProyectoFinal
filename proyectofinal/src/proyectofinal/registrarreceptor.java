 ...
 * @author Dmorillo
 */
public class registrarreceptor extends javax.swing.JFrame {

    public registrarreceptor() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(registrarreceptor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new registrarreceptor().setVisible(true);
            }
        });
    }
