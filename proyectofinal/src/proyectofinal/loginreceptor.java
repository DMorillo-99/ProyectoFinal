 ...
 * @author Dmorillo
 */
public class loginreceptor extends javax.swing.JFrame {

    /**
     * Creates new form loginreceptor
     */
    public loginreceptor() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loginreceptor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new loginreceptor().setVisible(true);
            }
        });
    }
